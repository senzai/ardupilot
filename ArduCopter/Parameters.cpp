...
const AP_Param::Info Copter::var_info[] PROGMEM = {
    ...
    // @Description: The deadzone above and below mid throttle.  Used in AltHold, SingleStick, Loiter, PosHold flight modes
    // @User: Standard
    // @Range: 0 300
    // @Units: pwm
    // @Increment: 1
    ...
    // @Values: 0:Stabilize,1:Acro,2:AltHold,3:Auto,4:Guided,5:Loiter,6:RTL,7:Circle,9:Land,11:Drift,12:SingleStick,13:Sport,14:Flip,15:AutoTune,16:PosHold,17:Brake
    // @User: Standard
