...
/** @brief  */
#ifndef HAVE_ENUM_LED_SET_COLOUR_PATTERN
#define HAVE_ENUM_LED_SET_COLOUR_PATTERN
typedef enum LED_SET_COLOUR_PATTERN
{
	...
	LED_SET_COLOUR_PATTERN_ENUM_END=256, /*  | */
} LED_SET_COLOUR_PATTERN;
#endif
...
#include "./mavlink_msg_led_set_colour.h"
